 ...
 */
    ...
    void Tracking::GrabGpsData(const GPS::NavSatFix& gpsMeasurement)
    {
        unique_lock<mutex> lock(mMutexImuQueue);
 ...
 */
    ...
    bool Tracking::PredictStateIMU()
    {
        ...
        // if the last keyframe is updated by the back end, use the last keyframe to preintegrate the current frame
        ...
        // if the last keyframe is not updated by the back end, use the last frame to preintegrate the current frame
    ...
    void Tracking::UpdateLocalPoints()
    {
        ...
        for (vector<KeyFrame*>::const_reverse_iterator
                 itKF = mvpLocalKeyFrames.rbegin(), itEndKF = mvpLocalKeyFrames.rend();
             itKF != itEndKF; ++itKF)
        {
            KeyFrame* pKF = *itKF;
