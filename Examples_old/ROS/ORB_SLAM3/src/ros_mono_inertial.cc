...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_imu = n.subscribe("/dji_osdk_ros/imu", 1000, &ImuGrabber::GrabImu, &imugb);
  ros::Subscriber sub_img0 = n.subscribe("/dji_osdk_ros/fpv_camera_images", 100, &ImageGrabber::GrabImage,&igb);
